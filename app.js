function init() {
    ...
    const hamburgur = document.querySelector('.menu')
    const hamburgurLines = document.querySelectorAll('.menu line')
    ...
    tl.to(navOpen, 0.5, { y: 0 })
        ...
        .fromTo(hamburgurLines, 0.2, { stroke: 'white' }, { stroke: 'black' }, '-=1')
